...
Запуск из каталога telegram_bot:  python -m scripts.send_onec_signal cancel|finish <appointment_id>
"""
...
def main(argv: list[str]) -> int:
    ...
    url = f"http://127.0.0.1:{settings.PORT}/api/v1/internal/{KINDS[argv[0]]}"
    response = httpx.post(
        url,
