"""Настройки MAX-бота. Все секреты — только из .env (конституция, принцип I)."""
...
class Settings(BaseSettings):
    ...
    DB_PATH: str = "max_appointments.db"
    LOG_DIR: str = "logs"
    HOST: str = "127.0.0.1"
    PORT: int = 8002

    _check_https = field_validator("MAX_API_URL", "WEBAPP_URL", "PD_POLICY_URL")(_https)
